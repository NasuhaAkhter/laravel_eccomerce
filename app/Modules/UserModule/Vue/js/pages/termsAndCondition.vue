				...
				<div class="_box _b_radious3 _padd20">
                    <div class="_1card_top _mar_b20">
                        <div class="_1card_top_left">
                            <p class="_1card_top_title">Terms And Conditions</p>
                        </div> 
      ...
      onEditorChange({ quill, html, text }) {
       ...
       async getAllrules(){
			...
			if(res.status==200){
                ...
                this.form.description = this.alldata.terms_and_condition
			}
        }, 
        async updateData(){
            ...
            this.isLoading=true
            this.alldata.terms_and_condition = this.form.description
            const res = await this.callApi('post','/usermodule/updateRules',this.alldata)
			if(res.status == 200){
                this.s("Terms And Conditions has been updated successfully");
                this.QuilOn = false
