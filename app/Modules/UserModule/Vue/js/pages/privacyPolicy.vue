				...
				<div class="_box _b_radious3 _padd20">
                    <div class="_1card_top _mar_b20">
                        <div class="_1card_top_left"> 
                            <p class="_1card_top_title">Privacy Ploicy</p>
                        </div> 
      ...
      onEditorChange({ quill, html, text }) {
       ...
       async getAllrules(){
			...
			if(res.status==200){
                ...
                this.form.description = this.alldata.privacy_policy
			}
        }, 
        async updateData(){
            ...
            this.isLoading=true
            this.alldata.privacy_policy = this.form.description
            const res = await this.callApi('post','/usermodule/updateRules',this.alldata)
			if(res.status == 200){
                this.s("Privacy Policy has been updated successfully");
                this.QuilOn = false
  			}
			else this.swr();
